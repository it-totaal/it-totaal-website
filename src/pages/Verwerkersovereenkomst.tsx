...
export default function Verwerkersovereenkomst() {
  return (
    <div className="min-h-screen bg-white">
      <SEO {...seoRoutes['/verwerkersovereenkomst']} />
      <header className="bg-[#0c1959] text-white py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center gap-3 mb-6">
            <Link to="/" className="text-slate-300 hover:text-white transition-colors">Home</Link>
            <span className="text-slate-500">/</span>
            <span>Verwerkersovereenkomst</span>
          </div>
          <h1 className="text-4xl md:text-5xl font-bold mb-4">Verwerkersovereenkomst</h1>
          <p className="text-xl text-blue-100 max-w-3xl">
            De verwerkersovereenkomst voor gegevensverwerking door IT Totaal Diensten BV.
          </p>
        </div>
      </header>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <section className="mb-16">
            ...
            <p className="text-slate-600 mb-8 max-w-3xl">
              De verwerkersovereenkomst van IT Totaal Diensten BV is beschikbaar als PDF-document.
            </p>
            ...
            <div className="bg-white border border-slate-200 rounded-xl p-8 hover:shadow-lg transition-shadow max-w-2xl">
              <div className="flex items-start gap-4">
                ...
                <div className="flex-1">
                  <h3 className="font-bold text-slate-900 mb-2">Verwerkersovereenkomst IT Totaal Diensten BV</h3>
                  <p className="text-sm text-slate-600 mb-4">PDF Document</p>
                  <a
                    href="/Verwerkersovereenkomst-2019.pdf"
                    target="_blank"
          ...
          <section>
            <div className="bg-white border border-slate-200 rounded-xl p-8">
              ...
              <p className="text-slate-600 mb-6">
                Voor vragen over de verwerkersovereenkomst kunt u contact met ons opnemen:
              </p>
